...
%Returns absorption, normalized. Photons absorbed/photons incident.
...
function [R,T,A,absi]=absorption(lambda,thetai,h,n,pol,r_amp,subs)
%% Initialize matrices
...
%% Build up transfer matrix, for each M calculate the coefficients and
%absorption
M=[1,0;0,1]; %start with unity matrix
E0=[1;r_amp]; %electric fields in layer 1 (air)

%Calculate absorption coefficient
alpha=4*pi*n/lambda; %imaginary part of this is what we will use as alphai
